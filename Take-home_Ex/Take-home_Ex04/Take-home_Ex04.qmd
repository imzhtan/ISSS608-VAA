...
We will create the slope graph to visualise how trade balance has decreased (in red) and increased (in blue) between January 2020 to December 2022. I set the origin as 0 since there is positive trade balance (trade surplus) and negative trade balance (trade deficit).
